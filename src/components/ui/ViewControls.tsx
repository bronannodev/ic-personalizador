...
export const ViewControls: React.FC<ViewControlsProps> = ({
  ...
  // Ajustar cámara a la parte trasera (vista principal del diseño)
  const setBackView = () => {
  ...
  // Ajustar cámara a perspectiva isométrica
  ...
  // Ajustar cámara a la parte delantera (pantalla)
  const setFrontView = () => {
    if (controlsRef.current) {
      controlsRef.current.object.position.set(0, 0, -9.5);
      controlsRef.current.target.set(0, 0, 0);
